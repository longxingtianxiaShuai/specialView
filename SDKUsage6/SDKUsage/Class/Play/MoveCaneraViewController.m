...
@interface MoveCaneraViewController ()<DropdownMenuDelegate,UIGestureRecognizerDelegate,MADelegate,UITextFieldDelegate>{
...
@implementation MoveCaneraViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"将摄像机标准点移动到输入的三维坐标";
