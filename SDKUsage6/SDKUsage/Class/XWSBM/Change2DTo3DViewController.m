...
@interface Change2DTo3DViewController ()<DropdownMenuDelegate,UIGestureRecognizerDelegate,MADelegate>{
...
@implementation Change2DTo3DViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"2DTO3D";
