...
@interface ChangeSBMViewController ()<DropdownMenuDelegate,MADelegate>
...
@implementation ChangeSBMViewController
...
- (void)dropdownMenu:(DropdownMenu *)menu selectedCellNumber:(NSInteger)number{
    ...
    //[_ma loadMap:[[_ma getDefaultBuildingId] intValue] floorId:floorInfo.floor_id];
    // [_ma changeFloorById:@"338236686"];
}
