...
@interface SBMAlphaViewController ()<DropdownMenuDelegate,MADelegate>
...
@implementation SBMAlphaViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"设置透明度";
}
...
- (void)addChangeBackColorMenu{
    ...
    NSArray *array = @[@"暂无透明度设置",@"%60",@"%0"];
    [dropdownMenu.mainBtn setTitle:@"透明度" forState:UIControlStateNormal];
