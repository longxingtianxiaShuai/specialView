...
#define RAD2DEG(X)  (X*57.2957914331332)
#define DEG2RAD(X)  (X*0.01745328888888)
#define VEC3_UNITX  (vec3(1.f,0.f,0.f))
#define VEC3_UNITY  (vec3(0.f,1.f,0.f))
#define VEC3_UNITZ  (vec3(0.f,0.f,1.f))

#define VB_CORE_DEBUG
